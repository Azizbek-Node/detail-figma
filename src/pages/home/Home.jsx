...
const Home = () => {
  ...
  const { data: wishlist } = useFetch("/wishlist/get")
    ...
    <div>
      <Hero />
        ...
        <Products
          ...
          style={{ parent: "grid max-[600px]:px-3 grid-cols-4 gap-6 max-[600px]:gap-2 max-[990px]:grid-cols-3 max-[600px]:grid-cols-2", child: "" }}
          isAdmin={false}
          data={data?.products}
        />
    </div>
